                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="<?php echo site_url('admin/login') ?>">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputPassword" type="password" name="password" placeholder="Password" value="<?php if ($session->getFlashdata('password')) echo $session->getFlashdata('password') ?>" />
